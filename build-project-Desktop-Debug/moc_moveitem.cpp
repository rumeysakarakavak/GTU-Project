...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MoveItem_t, stringdata) + ofs \
...
const QMetaObject MoveItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MoveItem.data,
      qt_meta_data_MoveItem,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MoveItem.stringdata))
        return static_cast<void*>(const_cast< MoveItem*>(this));
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< MoveItem*>(this));
